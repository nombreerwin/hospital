...
<html lang = "en">
	...
	<div class = "navbar navbar-default navbar-fixed-top">
		<img src = "images/hc.png" height = "55px" style = "float:left;"><label class = "navbar-brand">Health Center Patient Management System - San Carlos City</label>
	...
	<div id = "footer">
		<label class = "footer-title">&copy; Copyright Patient Health Center Management System 2023</label>
	</div>
	</body>
