...
<br />
	<div id="print">
		<div style = "margin:10px;">
			<img src = "images/hc.png" height = "100px" width = "100px" style = "float:left; position:relative; left:15%;" />
			<div style = "float:right; position:relative; right:35%;">
				<label><center>Republic of the Philippines</center></label>
				<label><center>Province of Pangasinan</center></label>
				<label><center>City of San Carlos</center></label>
